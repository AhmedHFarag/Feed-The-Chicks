...
public class CameraFollow : MonoBehaviour {
 ...
 //   public Transform PlayerFour;
    ...
    //public void AddPlayer(Transform Player1, Transform Player2, Transform Player3, Transform Player4)
    ...
    {
        try {
            transform.position = Vector3.SmoothDamp(transform.position, new Vector3((Distance / 2) + Mathf.Min(PlayerOne.localPosition.x, PlayerTwo.localPosition.x)-10, transform.localPosition.y, transform.position.z), ref velocity, Time.deltaTime * 10);
        }catch(System.Exception e)
        {
