...
public class IntroSpecialAbility : MonoBehaviour
{
    public delegate void EndSpecialAbility();

     public static event EndSpecialAbility OnSpecialAbilityTimeEnded;

    StanderedController stController;
    IntroChicksController playerController;
    ...
    void Awake()
    {
        ...
        playerController = gameObject.GetComponent<IntroChicksController>();
    ...
    void Update()
    {
        ...
        if (callAbility)
        {
            ...
            {
                if (OnSpecialAbilityTimeEnded != null) { OnSpecialAbilityTimeEnded(); }
